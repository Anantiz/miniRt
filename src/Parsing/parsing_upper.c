...
/*   Updated: 2024/02/26 14:53:37 by aurban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_camera(t_glob *glob, char **line_tokens)
{
	...
	camera->rad_fov = (float)camera->fov * M_PI / 180;
	camera->screen_ratio = (float)glob->win_size.height / (float)glob->win_size.width;
